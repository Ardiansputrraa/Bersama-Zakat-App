 ...
 * Use the [RefrensiPandanganFragment.newInstance] factory method to
...
class RefrensiPandanganFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RefrensiPandanganFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RefrensiPandanganFragment().apply {
